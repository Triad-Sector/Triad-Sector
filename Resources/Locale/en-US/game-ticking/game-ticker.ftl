...
game-ticker-player-join-game-message = Welcome to Triad Sector! If this is your first time playing, be sure to read the game rules, and don't be afraid to ask for help in LOOC (local OOC) or OOC (usually available only between rounds).
...
game-ticker-get-info-preround-text = Hi and welcome to [color=white]Triad Sector![/color]
                            The current round is: [color=white]#{$roundId}[/color]
